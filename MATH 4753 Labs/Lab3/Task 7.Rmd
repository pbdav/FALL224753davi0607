...
renderPlot({
 ...
 gb = g + geom_point(aes(col = BHDiameter)) 
 
 gsh =  g + geom_point(aes(size = Height, col = Height))
 
 gsb = g + geom_point(aes(size = BHDiameter, col = BHDiameter))
  
 if(input$plotg == "g") print(g)
 
 if(input$plotg == "gheight")   print(gh)
 
 if(input$plotg == "gsbhdiameter")   print(gsb)
 
 if(input$plotg == "gsheight")   print(gsh)
 
 if(input$plotg == "gbhdiameter")   print(gr)
